    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {isLoading && <Loader />}
          {!isLoading && !error && (
            <MovieList movies={movies} onselectId={handelSelect} />
          )}
...
// function RateListMain({ children }) {
...
function ListMovie({ watched, onDeleteWatched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie
